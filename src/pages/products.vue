...
import ProductSteper from '@/components/ProductSteper/ProductSteper.vue'
import usePageConfig from '@/page-configs/product'
...
const onConfirm = async () => {
  try {
    ...
    const res = await axios.delete('products/' + selectedRecord.value?.id)
