...
import EstateSteper from '@/components/EstateSteper/EstateSteper.vue'
import usePageConfig from '@/page-configs/estates'
...
const onConfirm = async () => {
  try {
    ...
    const res = await axios.delete('estates/' + selectedRecord.value?.id)
